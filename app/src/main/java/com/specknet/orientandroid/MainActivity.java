...
//        groupSpinner.setAdapter(adapter2);
        ...
        activity_list.add("---");
        activity_list.add("Walking, no cough");
        activity_list.add("Walking, coughing");
        activity_list.add("Walking, talking");
        activity_list.add("Walking, laughing");
        activity_list.add("Climbing stairs, no cough");
        activity_list.add("Climbing stairs, coughing");
        activity_list.add("Descending stairs, no cough");
        activity_list.add("Descending stairs, coughing");
        activity_list.add("Running, no cough");
        activity_list.add("Running, coughing");
        activity_list.add("Standing, coughing");
        activity_list.add("Standing, no cough");
        activity_list.add("Lying down, no cough");
        activity_list.add("Lying down, coughing");
        activity_list.add("Sitting, no cough");
        activity_list.add("Sitting, coughing");
        activity_list.add("Talking");
        activity_list.add("Normal Breathing");
        activity_list.add("Laughing");
        activity_list.add("Eating, swallowing");
        activity_list.add("Singing");
        activity_list.add("Swinging back and forth");
        activity_list.add("Spinning");
        activity_list.add("Hyperventilation");
        ...
        start_button.setOnClickListener(v-> {
            ...
            if (act_type_str == null || (nameEditText.getText().toString().length() == 0)) {
...
//                mounting_str = rb.getText().toString();
                ...
                file = new File(path, "HonsProj" + "_" + name_str + "_" + file_ts + ".csv");
...
//        }
        if (parent.getId() == activitySpinner.getId()) {
